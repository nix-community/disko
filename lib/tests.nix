  ...
  testLib = {
    ...
    makeDiskoTest =
      ...
      let
        ...
        tsp-format = (tsp-generator.format testConfigInstall) pkgs;
        tsp-mount = (tsp-generator.mount testConfigInstall) pkgs;
        tsp-disko = (tsp-generator.destroyFormatMount testConfigInstall) pkgs;
